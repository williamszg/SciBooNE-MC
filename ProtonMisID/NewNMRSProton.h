...
// Tue Oct  3 11:18:50 2017 by ROOT version 6.10/02
// from TTree nRooTracker/Pure NEUT RooTracker
// found on file: SciBooNE_numu_coh_RooTrack.root
//////////////////////////////////////////////////////////

#ifndef NewNMRSProton_h
#define NewNMRSProton_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
 ...
 //TObjString      *EvtCode;
   ...
   NewNMRSProton(TTree *tree=0);
   virtual ~NewNMRSProton();
...
#ifdef NewNMRSProton_cxx
NewNMRSProton::NewNMRSProton(TTree *tree) : fChain(0) 
{
...
NewNMRSProton::~NewNMRSProton()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t NewNMRSProton::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t NewNMRSProton::LoadTree(Long64_t entry)
{
...
void NewNMRSProton::Init(TTree *tree)
{
...
void NewNMRSProton::Show(Long64_t entry)
{
...
Int_t NewNMRSProton::Cut(Long64_t entry)
{
