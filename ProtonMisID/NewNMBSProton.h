...
// Fixed size dimensions of array or collections stored in the TTree if any.
 ...
 //TObjString      *EvtCode;
   ...
   NewNMBSProton(TTree *tree=0);
   virtual ~NewNMBSProton();
...
#ifdef NewNMBSProton_cxx
NewNMBSProton::NewNMBSProton(TTree *tree) : fChain(0) 
{
...
NewNMBSProton::~NewNMBSProton()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t NewNMBSProton::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t NewNMBSProton::LoadTree(Long64_t entry)
{
...
void NewNMBSProton::Init(TTree *tree)
{
...
void NewNMBSProton::Show(Long64_t entry)
{
...
Int_t NewNMBSProton::Cut(Long64_t entry)
{
