...
// Fixed size dimensions of array or collections stored in the TTree if any.
 ...
 //TObjString      *EvtCode;
   ...
   NewANMBSProton(TTree *tree=0);
   virtual ~NewANMBSProton();
...
#ifdef NewANMBSProton_cxx
NewANMBSProton::NewANMBSProton(TTree *tree) : fChain(0) 
{
...
NewANMBSProton::~NewANMBSProton()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t NewANMBSProton::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t NewANMBSProton::LoadTree(Long64_t entry)
{
...
void NewANMBSProton::Init(TTree *tree)
{
...
void NewANMBSProton::Show(Long64_t entry)
{
...
Int_t NewANMBSProton::Cut(Long64_t entry)
{
...
#endif // #ifdef NewANMBSProton_cxx
