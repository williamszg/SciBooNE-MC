#define NewANMBergerSehgal_cxx
#include "NewANMBergerSehgal.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <TRandom.h>
...
void NewANMBergerSehgal::Loop()
{
   ...
   TFile *TMuonInfo = new TFile("./ROOTFILES/totalmuoninfoBSBar.root", "RECREATE");
